...
Encore
    ...
    // Configure PurgeCSS
    // See: https://purgecss.com/plugins/webpack.html
    .addPlugin(new PurgeCSSPlugin({
        paths: [
            ...glob.sync(path.join(__dirname, 'templates', '**', '*.html.twig'), { nodir: true }),
            ...glob.sync(path.join(__dirname, 'src', '**', '*.php'), { nodir: true }),
        ],
        safelist: {
            standard: [
                ...
                // Dynamically generated by draw-line-map controller (city search)
                /^draw-line-map-search__/,
                // Dynamically generated per measure type (e.g. app-card--measure-noEntry)
                /^app-card--measure-/
            ],
            greedy: [
