...
final class DuplicateRegulationControllerTest extends AbstractWebTestCase
{
    ...
    public function testDuplicate(): void
    {
        ...
        $this->assertSame('Rue des Graviers à Saint-Ouen-sur-Seine Afficher la carte Masquer la carte Aperçu de la localisation', $measures->eq(0)->filter('.app-card__content li')->eq(3)->text());
    }
