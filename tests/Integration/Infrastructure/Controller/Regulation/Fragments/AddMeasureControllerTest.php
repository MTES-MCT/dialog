...
final class AddMeasureControllerTest extends AbstractWebTestCase
{
    ...
    public function testInvalidLaneBlankCityCode(): void
    {
        ...
        $this->assertResponseStatusCodeSame(422);
        $this->assertSame('Veuillez choisir une ville ou code postal parmi la liste.', $crawler->filter('#measure_form_locations_0_namedStreet_cityLabel_error')->text());
    }
    ...
    public function testAddRawGeoJSONAsUserHidden(): void
    {
        ...
        $this->assertSame('disabled', $roadTypeOptions->eq(3)->attr('disabled'));
    }
