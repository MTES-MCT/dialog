...
final class UpdateLocationControllerTest extends AbstractWebTestCase
{
    ...
    {
        $client = $this->login();
        $crawler = $client->request('GET', '/_fragment/regulations/e413a47e-5928-4353-a8b2-8b7dda27f9a5/location/51449b82-5032-43c8-a427-46b9ddb44762/edit');
    ...
    {
        $client = $this->login();
        $client->request('GET', '/_fragment/regulations/c1beed9a-6ec1-417a-abfd-0b5bd245616b/location/51449b82-5032-43c8-a427-46b9ddb44762/edit');
    ...
    {
        $client = $this->login();
        $client->request('GET', '/_fragment/regulations/e413a47e-5928-4353-a8b2-8b7dda27f9a5/location/c1beed9a-6ec1-417a-abfd-0b5bd245616b/edit');
    ...
    {
        $client = $this->login();
        $client->request('GET', '/_fragment/regulations/aaaaa/location/bbbbb/edit');
    ...
    {
        $client = $this->login();
        $client->request('GET', '/_fragment/regulations/e413a47e-5928-4353-a8b2-8b7dda27f9a5/location/51449b82-5032-43c8-a427-46b9ddb44762/edit');
        $this->assertResponseStatusCodeSame(200);
