...
final class GetLocationControllerTest extends AbstractWebTestCase
{
    public function testGet(): void
    {
        ...
        $this->assertSame('Vitesse Limitée à 50 Km/h du lundi au mardi de 08h00 à 22h00 pour tous les véhicules', $crawler->filter('li')->eq(2)->text());
    ...
    public function testGetWithComplexVehicles(): void
    {
        ...
        $this->assertSame(
            'Circulation interdite le jeudi de 08h00 à 22h00 pour les poids lourds de plus de 3.5 tonnes, 12 mètres de long ou 2.4 mètres de haut, crit\'air 4 et crit\'air 5, sauf piétons, véhicules sanitaires et convois exceptionnels',
