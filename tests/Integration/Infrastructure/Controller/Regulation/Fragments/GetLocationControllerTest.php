...
final class GetLocationControllerTest extends AbstractWebTestCase
{
    public function testGet(): void
    {
        ...
        $this->assertSame('http://localhost/_fragment/regulations/e413a47e-5928-4353-a8b2-8b7dda27f9a5/location/51449b82-5032-43c8-a427-46b9ddb44762/edit', $crawler->filter('a')->link()->getUri());
    }
    ...
    public function testGetCityOnly(): void
    {
        ...
        $this->assertSame('http://localhost/_fragment/regulations/4ce75a1f-82f3-40ee-8f95-48d0f04446aa/location/f15ed802-fa9b-4d75-ab04-d62ea46597e9/edit', $crawler->filter('a')->link()->getUri());
    }
