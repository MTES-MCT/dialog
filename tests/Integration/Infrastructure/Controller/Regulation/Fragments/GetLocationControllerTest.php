...
final class GetLocationControllerTest extends AbstractWebTestCase
{
    public function testGet(): void
    {
        ...
        $this->assertSame('Circulation interdite du 13/03/2023 - 00h00 au 15/03/2023 - 23h59 pour tous les véhicules', $crawler->filter('li')->eq(2)->text());
    ...
    public function testGetWithComplexVehicles(): void
    {
        ...
        $this->assertSame(
            'Circulation interdite du 10/03/2023 - 08h00 au 20/03/2023 - 22h00, le jeudi pour les poids lourds de plus de 3.5 tonnes, 12 mètres de long ou 2.4 mètres de haut, crit\'air 4 et crit\'air 5, sauf piétons, véhicules d\'urgence et convois exceptionnels',
