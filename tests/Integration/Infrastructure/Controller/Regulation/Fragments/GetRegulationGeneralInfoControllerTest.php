...
final class GetRegulationGeneralInfoControllerTest extends AbstractWebTestCase
{
    public function testGet(): void
    {
        ...
        $this->assertSame('entitled 3', $crawler->filter('h3')->text());
        ...
        $this->assertSame('entitled 3', $crawler->filter('li')->eq(2)->text());
    ...
    public function testGetDescriptionTruncated(): void
    {
        ...
        $this->assertResponseStatusCodeSame(200);
        $this->assertSecurityHeaders();
        $this->assertSame('entitled 5 that is very long and...', $crawler->filter('h3')->text());
    }
