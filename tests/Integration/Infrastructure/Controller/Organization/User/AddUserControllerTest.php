...
final class AddUserControllerTest extends AbstractWebTestCase
{
    public function testAdd(): void
    {
        ...
        $crawler = $client->request('GET', '/organizations/' . OrganizationFixture::MAIN_ORG_ID . '/users/add');
    ...
    {
        $client = $this->login();
        $client->request('GET', '/organizations/' . OrganizationFixture::MAIN_ORG_ID . '/users/add');
    ...
    {
        $client = $this->login();
        $client->request('GET', '/organizations/' . OrganizationFixture::OTHER_ORG_ID . '/users/add');
        $this->assertResponseStatusCodeSame(403);
    }
    ...
    {
        $client = $this->login();
        $client->request('GET', '/organizations/f5c1cea8-a61d-43a7-9b5d-4b8c9557c673/users/add');
