...
final class GetMapLocationFragmentControllerTest extends AbstractWebTestCase
{
    public function testGet(): void
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/_fragment/map/location/' . LocationFixture::UUID_PUBLISHED);
    ...
    {
        $client = static::createClient();
        $client->request('GET', '/_fragment/map/location/' . LocationFixture::UUID_DOES_NOT_EXIST);
