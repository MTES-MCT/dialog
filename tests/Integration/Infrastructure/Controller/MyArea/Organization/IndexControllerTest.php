...
final class IndexControllerTest extends AbstractWebTestCase
{
    ...
    public function testWithOrganizationsNotCompleted(): void
    {
        ...
        $this->assertSame('Complétez les informations de vos organisations Ajouter un logo à votre organisation, configurer des modèles d’arrêtés, créer une liste de diffusion, etc. Voir mes organisations Masquer le message', $warningNotice->filter('[data-testid="organization-not-completed"]')->text());
