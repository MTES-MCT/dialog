...
final class EditOrganizationControllerTest extends AbstractWebTestCase
{
    public function testEdit(): void
    {
        ...
        $crawler = $client->request('GET', '/mon-espace/organizations/' . OrganizationFixture::MAIN_ORG_ID . '/edit');

        $this->assertResponseStatusCodeSame(200);
        $this->assertSecurityHeaders();
        $this->assertSame('Mon organisation', $crawler->filter('h2')->text());
        $this->assertMetaTitle('Mon organisation - DiaLog', $crawler);
