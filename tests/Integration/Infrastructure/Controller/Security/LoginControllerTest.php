...
final class LoginControllerTest extends AbstractWebTestCase
{
    public function testLoginSuccessfully(): void
    {
        ...
        $this->assertSame('Mes organisations Mathieu MARCHOIS Mathieu MARCHOIS mathieu.marchois@beta.gouv.fr Mon compte Se déconnecter', $crawler->filter('[data-testid="user-links"]')->text());
    }
    ...
    public function testLoginAsAdminSuccessfully(): void
    {
        ...
        $this->assertResponseStatusCodeSame(302);
        $crawler = $client->followRedirect();
        $this->assertSame('Mes organisations Mathieu FERNANDEZ Mathieu FERNANDEZ mathieu.fernandez@beta.gouv.fr Mon compte Administration Se déconnecter', $crawler->filter('[data-testid="user-links"]')->text());
    }
