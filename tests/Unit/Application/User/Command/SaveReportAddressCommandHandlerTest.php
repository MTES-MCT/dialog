...
final class SaveReportAddressCommandHandlerTest extends TestCase
{
    ...
    public function testHandle(): void
    {
        ...
        $this->ignReportClient
            ...
            ->with(
                ...
                'POLYGON((2 46, 3 46, 3 47, 2 47, 2 46))',
            )
    ...
    public function testHandleWithRoadBanIdFailure(): void
    {
        ...
        $this->logger
            ...
            ->method('info')
            ->with(
                'Failed to get geometry from roadBanId, will use organization geometry',
                $this->callback(function (array $context) {
                    return isset($context['roadBanId']) && $context['roadBanId'] === 'road-ban-id-123';
                }),
            );
