...
- `measure` (object, nullable)
  ...
  - `locations` (array<object>, nullable)
    ...
    - `namedStreet` (object, nullable) — utilisé avec `roadType = lane`
      - `cityCode`, `cityLabel`, `roadBanId`, `roadName` (string, nullable)
      - `fromPointType`, `fromHouseNumber`, `fromRoadBanId`, `fromRoadName` (string, nullable)
      - `toPointType`, `toHouseNumber`, `toRoadBanId`, `toRoadName` (string, nullable)
