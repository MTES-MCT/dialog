...
final class Version20250407142930 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE mailing_list (uuid UUID NOT NULL, organization_uuid UUID NOT NULL, name VARCHAR(100) NOT NULL, email VARCHAR(255) NOT NULL, function VARCHAR(150) DEFAULT NULL, PRIMARY KEY(uuid))');
