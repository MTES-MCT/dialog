...
final class Version20230620075741 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE vehicle_set (uuid UUID NOT NULL, measure_uuid UUID NOT NULL, restricted_types TEXT NOT NULL, other_restricted_type_text VARCHAR(100) DEFAULT NULL, exempted_types TEXT NOT NULL, other_exempted_type_text VARCHAR(100) DEFAULT NULL, PRIMARY KEY(uuid))');
