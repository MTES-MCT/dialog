...
final class Version20251124171554 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE report_address (uuid UUID NOT NULL, user_uuid UUID NOT NULL, content TEXT NOT NULL, road_type VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, has_been_contacted BOOLEAN DEFAULT false, PRIMARY KEY(uuid))');
