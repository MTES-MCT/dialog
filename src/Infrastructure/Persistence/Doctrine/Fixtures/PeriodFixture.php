...
final class PeriodFixture extends Fixture implements DependentFixtureInterface
{
    ...
    {
        // NOTE : les dates sont à saisir en UTC, de sorte que 23h00/22h59 correspondent à 00h00/23h59 saisis dans l'UI.
        ...
        $cifsPeriod1 = new Period(
            ...
            startDateTime: new \DateTimeImmutable('2023-09-04 23:00:00'),
            endDateTime: new \DateTimeImmutable('2023-09-06 22:59:00'),
            recurrenceType: PeriodRecurrenceTypeEnum::CERTAIN_DAYS->value,
        );
        ...
        $cifsPeriod2 = new Period(
            ...
            measure: $this->getReference('cifsMeasure'),
            startDateTime: new \DateTimeImmutable('2023-09-02 23:00:00'),
            endDateTime: new \DateTimeImmutable('2023-09-06 22:59:00'),
            recurrenceType: PeriodRecurrenceTypeEnum::CERTAIN_DAYS->value,
        );
