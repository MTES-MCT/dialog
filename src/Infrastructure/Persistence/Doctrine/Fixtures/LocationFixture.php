...
final class LocationFixture extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $cifsLocation = new Location(
            ...
            fromHouseNumber: '21',
            toHouseNumber: '33',
            geometry: '{"type":"LineString","crs":{"type":"name","properties":{"name":"EPSG:2154"}},"coordinates":[[1.354885586,44.016343822],[1.35476043,44.01639595],[1.35431163,44.01660254],[1.354256366,44.016628823]]}',
