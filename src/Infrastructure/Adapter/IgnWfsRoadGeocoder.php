...
final class IgnWfsRoadGeocoder implements RoadGeocoderInterface
{
    ...
    {
        //https://data.geopf.fr/wfs/ows?SERVICE=WFS&REQUEST=GetFeature&VERSION=2.0.0&OUTPUTFORMAT=application/json&TYPENAME=BDTOPO_V3:voie_nommee&cql_filter=nom_minuscule=%27rue%20de%20flandre%27%20AND%20code_insee=59368&PropertyName=geometrie
        ...
        $query = [
            ...
            'cql_filter' => sprintf("nom_minuscule='%s' AND insee_code='%s'", $roadName, $inseeCode ),
        ];
