...
final class AddRegulationController
{
    ...
    #[OA\Response(
        response: 422,
        description: 'Erreur de validation ou métier (géocodage / périmètre géographique)',
        content: new OA\JsonContent(
            oneOf: [
                new OA\Schema(
                    type: 'object',
    ...
    public function __invoke(
        ...
        $regulationOrderRecord = $this->commandBus->handle(new SaveRegulationWithMeasureCommand($generalInfo, $dto->measure));
