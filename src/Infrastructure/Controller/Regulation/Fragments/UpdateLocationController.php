...
final class UpdateLocationController extends AbstractRegulationController
{
    ...
    #[Route(
        '/_fragment/regulations/{regulationOrderUuid}/location/{uuid}/edit',
        name: 'fragment_regulations_location_update',
        methods: ['GET', 'POST'],
    )]
    public function __invoke(Request $request, string $regulationOrderUuid, string $uuid): Response
    {
        ...
        $form = $this->formFactory->create(
            ...
            options: [
                'action' => $this->router->generate('fragment_regulations_location_update', [
                    'regulationOrderUuid' => $regulationOrderUuid,
                    'uuid' => $uuid,
                ]),
                'isEdit' => true,
            ],
