...
final class EudonetParisReporter
{
    ...
    public const ERROR_MAX_SPEED_PARSING_FAILED = 'max_speed_parsing_failed';
    ...
    public const ERROR_EUDONET_MEASURE_ALINEA_MAY_CONTAIN_DATES = 'eudonet_measure_alinea_may_contain_dates';
    public const ERROR_VALUE_DOES_NOT_MATCH_PATTERN = 'value_does_not_match_pattern';
    public const ERROR_UNSUPPORTED_LOCATION_FIELDSET = 'unsupported_location_fieldset';
    ...
    public const WARNING_PERMANENT_CATEGORY_MISMATCH = 'permanent_category_mismatch';
