...
final readonly class LitteralisTransformer
{
    private const MEASURE_MAP = [
        ...
        'SOGELINK - Interdiction de stationnement' => MeasureTypeEnum::PARKING_PROHIBITED->value,
        'Interdiction de dépasser' => MeasureTypeEnum::NO_OVERTAKING->value,
        'Interdiction de dépasser (Arrêté Permanent)' => MeasureTypeEnum::NO_OVERTAKING->value,
        ...
        'SOGELINK - Circulation alternée' => MeasureTypeEnum::ALTERNATE_ROAD->value,
    ];
