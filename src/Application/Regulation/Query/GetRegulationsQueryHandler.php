...
final class GetRegulationsQueryHandler
{
    ...
    {
        $regulations = $this->repository->findRegulations($query->page, RegulationOrderRecordStatusEnum::DRAFT);
        $totalItems = $this->repository->countRegulations(RegulationOrderRecordStatusEnum::DRAFT);
